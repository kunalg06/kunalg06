...
<h3 align="center">AI / Machine Learning Engineer | NLP • LLM Systems • Computer Vision</h3>
...
💼 **4+ years** of experience building and deploying ML solutions in production  
🔍 Currently focused on **LLM Systems, RAG pipelines, and Conversational AI**  
🌍 Based in the **United Kingdom** | 🗺️ **Open to new opportunities**

I've delivered production AI systems at **Quantiphi** and **Winjit Technologies** — from transformer-based NLP pipelines to computer vision systems for enterprise clients like Mahindra & Mahindra. I love turning complex AI research into practical, scalable solutions.
...
| Research Associate | Sports Engineering Research Group, Sheffield Hallam | Jul – Oct 2023 |

---

## 📜 Certifications

- 🎓 PGDM in Machine Learning & AI — IIIT Bangalore (2021)
- 📊 IBM Data Analyst Professional Certificate — Coursera (2024)
- 🤖 IBM Generative AI for Data Scientists Specialization — Coursera (2024)
...
<p align="center">
  💬 <i>Open to ML Engineer, Data Scientist, and AI Engineer roles in the UK or remote.</i><br/>
